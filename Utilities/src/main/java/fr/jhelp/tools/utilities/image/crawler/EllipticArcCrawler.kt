...
package fr.jhelp.tools.utilities.image.crawler

import fr.jhelp.tools.utilities.math.AngleFloat
import fr.jhelp.tools.utilities.math.Matrix
import fr.jhelp.tools.utilities.math.PI_FLOAT
import fr.jhelp.tools.utilities.math.Point2D
import fr.jhelp.tools.utilities.math.TWO_PI_FLOAT
import fr.jhelp.tools.utilities.math.obtainRotateMatrix
...
/**
 * Compute a crawler along an elliptic arc
 */
                                  ...
                                  precision: Int)
{
    ...
    /**
     * Get a point on the arc at the given step
     * @param step Step to get
     * @return Point on the arc
     * @throws IllegalArgumentException If step is not in [0, [numberStep]]
     */
